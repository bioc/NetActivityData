#' Annotation of GO_KEGG model trained with GTEx samples
#'

#' We provide the annotation for the gene sets present in the GO_KEGG model trained
#' with the GTEx samples. This object contains the GO terms and KEGG pathways names
